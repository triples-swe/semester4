    ...
    <div id="servicesCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="${pageContext.request.contextPath}/resources/images/web-development.jpg" alt="Web Development" class="d-block w-100">
            ...
            <div class="carousel-item">
                <img src="${pageContext.request.contextPath}/resources/images/mobile-app-development.jpg" alt="Mobile App Development" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="${pageContext.request.contextPath}/resources/images/data-science.jpg" alt="Data Science" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Data Science</h5>
            ...
            <div class="carousel-item">
                <img src="${pageContext.request.contextPath}/resources/images/machine-learning.jpg" alt="Machine Learning" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
